...
# 2 "<built-in>" 2
# 1 "modules/buttons.c" 2
# 1 "modules/buttons.h" 1
# 10 "modules/buttons.h"
...
# 11 "modules/buttons.h" 2
void buttons_update(void);
extern uint8_t S1_pressed;
...
void buttons_update(void)
{
    ...
    uint8_t now_S1 = PORTBbits.RB4;
    uint8_t now_S2 = PORTCbits.RC5;


    if (prev_S1 == 1 && now_S1 == 0)
    {
        ui_next_state();
    }
    S1_pressed = (now_S1 == 0);
