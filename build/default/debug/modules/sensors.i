...
void sensors_update(void)
{
    ...
    uint16_t adc_val = ADCC_GetSingleConversion(channel_ANA0);


    uint8_t level = adc_val >> 10;
    if (level > 3)
        level = 3;
